...
USE [cargoquin]
GO
/****** Object:  StoredProcedure [dbo].[USP_CustomerPortal_SHIPTDetailByShipFolio]    **/
SET ANSI_NULLS ON
GO
...
-- Description:	Consulta de resumen de shipments en detalle por shipfolio
-- =============================================

CREATE PROCEDURE [dbo].[USP_CustomerPortal_SHIPTDetailByShipFolio]
--ALTER PROCEDURE [dbo].[USP_CustomerPortal_SHIPTDetailByShipFolio]
	  ...
	  -- insertar detalle 
	    INSERT INTO #tempShipM( 
				  ...
				  bs.intRecId,  bs.intRecStatOut
				   ...
				   ---
				   delete from #tempShipBS
				   where #tempShipBS.strShipFolio not like '%' +@strShipFolio+'%'
				   /*
