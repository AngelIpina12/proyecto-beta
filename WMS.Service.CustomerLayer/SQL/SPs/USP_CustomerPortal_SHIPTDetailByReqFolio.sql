...
USE [cargoquin]
GO
/****** Object:  StoredProcedure [dbo].[USP_CustomerPortal_SHIPTDetailByReqFolio]    **/
SET ANSI_NULLS ON
GO
...
--CREATE PROCEDURE [dbo].[USP_CustomerPortal_SHIPTDetailByReqFolio]
ALTER PROCEDURE [dbo].[USP_CustomerPortal_SHIPTDetailByReqFolio]

----WMSPREPROD.WMSPREPRODDBV24.dbo.
----WMSPREPROD.WMSPREPRODDBV24.Security

(@intUserId INT NULL
,@strReqFolio varchar(22) NULL
	  ...
	  -- insertar detalle 
	    INSERT INTO #tempShipM( 
				  ...
				  bs.intRecId,  bs.intRecStatOut
				   ...
				   ---
				   delete from #tempShipM
				   where #tempShipM.strCQFolio not like '%' +@strReqFolio+'%'
				   /*
