...
USE [cargoquin]
GO
/****** Object:  StoredProcedure [dbo].[USP_CustomerPortal_INVSupSKU]    **/
SET ANSI_NULLS ON
GO
...
-- Description:	Consulta de inventario filtradro por supplier SKU
-- =============================================

--CREATE PROCEDURE [dbo].[USP_CustomerPortal_INVSupSKU]
ALTER PROCEDURE [dbo].[USP_CustomerPortal_INVSupSKU]
...
BEGIN 
	...
	----------------
	   ...
	   WHERE tinv.intInvId = inv.Id
		...
		AND INVDTT.ProductNumber LIKE '%'+@strSupSKU +'%'
	   ...
	   --							)
		...
		--	where tbc.intinvid >0						
		 ...
		 SELECT
		  ...
		  GROUP BY   strSKUSupplier ,strUOM ,strWayShip 
